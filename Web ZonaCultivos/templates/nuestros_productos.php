    ...
    <div class="container">
        ...
        <div class="plantas">
            ...
            <div class="text-center">
                <img src="/assets/images/plantas.jpg" alt="Variedad de Plantas" class="img-fluid rounded shadow">
            </div>
        </div>
        ...
        <div class="envios-condiciones mb-5">
            ...
            <p>Hacenos tu consulta, indicando tipo de césped que buscás, zona y cantidad y te compartimos un presupuesto personalizado.</p>
        </div>
    </div>
</section>
